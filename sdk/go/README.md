...
- <img src="../../docs/icons/lock.svg" width="24" height="24" alt="" /> **Type-safe**: All request/response types generated from OpenAPI spec
- <img src="../../docs/icons/rocket.svg" width="24" height="24" alt="" /> **Easy to use**: Simple, idiomatic Go API
- <img src="../../docs/icons/key.svg" width="24" height="24" alt="" /> **Authentication**: Built-in support for API Gateway API keys
- <img src="../../docs/icons/doc.svg" width="24" height="24" alt="" /> **Well-documented**: Complete examples and godoc comments
- <img src="../../docs/icons/check.svg" width="24" height="24" alt="" /> **Production-ready**: Generated by industry-standard oapi-codegen
